...
function PopularTvshows() {
  ...
  return (
    <div>
      <h2 className="text-xl font-semibold p-3">Popular Tv-Shows</h2>
        ...
        {data.results.slice(0, 18).map((movies) => (
          ...
          >
            ...
            <div className="p-4 flex flex-col justify-between flex-grow">
              <h4 className="text-lg font-bold">{movies.name}</h4>
              ...
              <Link to={`/moviedetails/${movies.id}`}>
                <button className="bg-black text-white text-sm p-2 rounded-md hover:bg-gray-700 hover:cursor-pointer bottom-2">
                  Watch Now
                </button>
              </Link>
            </div>
